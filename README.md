...
87. Найти сумму <pre>10+11+12+13+...+88. Ответ: 3871</pre>  
88. Найти произведение <pre>5⋅6⋅7⋅...⋅13.</pre>  
89. Найти сумму  <pre>1+4+7+11+...+112.</pre>  
90. Найти сумму <pre>cos35+cos57+cos79+...+cos111113.</pre>  
91. Найти сумму <pre>23+34+45+...+910.</pre>  
92. Вывести на экран сто первых сумм вида <pre>1+2+3+...+n.</pre>  
93. Найдите сумму квадратов первых n натуральных чисел  
94. Найдите сумму <pre>1+12+13+…+1n.</pre>  
95. Даны a и n. Вычислите <pre>p=(a+1)2(a+2)2⋅…⋅(a+n)2</pre>  
96. Дано натуральное число n. Вычислите <pre>1cosx+1cosx2+…+1cosxn</pre>  
97. Вычислите <pre>1⋅2+2⋅3⋅4+...+n⋅(n+1)⋅…⋅2n.</pre>  
