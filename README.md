...
Вывести на экран букву "W" из символов "*" (звездочка). программирование
...
Дано число a. Не пользуясь никакими арифметическими операциями кроме умножения, получите а)a4 за две операции; б) a6 за три операции; в) a15 за пять операций.
...
Выведите на экран квадрат из нулей и единиц, причем нули находятся только на диагонали квадрата. Всего в квадрате сто цифр. Материал сайта www.itmathrepetitor.ru
